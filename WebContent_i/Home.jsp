...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    if (session.getAttribute("name") == null) {
    	...
    	out.println("<a class='btn btn-primary' href='Login.jsp' style='float:right; margin-right:0; margin-left:auto;'> Login </a>");    
    } else {
        // Already created.
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="card-header text-center">
      <a href="Home.jsp" class="h1"><b>TECH</b>BEE</a>
    </div>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <%     
                      ...
                      ResultSet rs = stmt.executeQuery("SELECT User_Id, First_name, Email_Id, Country FROM POC_work.userslogin");
