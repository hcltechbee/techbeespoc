  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><% if(session.getAttribute(com.constants.UIConstants.SESSION_NAME)!= null){out.println(session.getAttribute(com.constants.UIConstants.SESSION_NAME));} else response.sendRedirect("Login.jsp"); %></a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title"><b>Search RM For Specified User</b></h3>
        </div>
      </div>
      
      <div class="jumbotron">
    	<form action="RMSearch.jsp" method="POST">
    		
    		<div class="container">
    				<div class="row">
    						<div class="col-md-4">	
    								<div class="form-group">
    									<input type="text" name="NameToSearch" placeholder="ENTER FIRST NAME OF USER" class="form-control" required pattern="[A-Za-z]{3,}">
    										</div>
    										<br>	
