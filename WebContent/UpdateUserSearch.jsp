		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a href="UPDATEUsingSearch.jsp"
...
//                 out.println("<td>"+currentUser.getUser_id()+"</td>");
                ...
                out.println("<a href='#modal-info' class=\"btn btn-info updatebtn\"><i class=\"fas fa-user-edit\"></i></a>");
            ...
            out.println("<button type='button' id='confirmUpdate' class='btn btn-outline-light confirmUPDATE'>YES</a>");
                      }  }
              %>
 ...
 var sno=0;
 console.log('hello')
	confirms = document.getElementsByClassName('updatebtn');
	console.log('hello 2');
	...
	confirmUpdate.addEventListener('click', (e)=>{
		console.log(sno);
		window.setTimeout(`window.location='UpdateUserPage.jsp?id='+sno`, 1000);
	     })
	    })
	  })
</script>
