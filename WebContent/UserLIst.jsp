...
<title>TechBee | Search User</title>
				...
				<div class="card-body p-0">
					<table class="table">
                     ...
                     String NameToFilter=request.getParameter("secondName");
                      List<User> list = UsersDataBase.getAllEmployee(nameToFilter,NameToFilter);                     //
                      if (list.size()==0){
...
//                 out.println("<td>"+currentUser.getUser_id()+"</td>");
            ...
            <p>PLEASE CONFIRM TO DELETE REPORTING MANAGER&hellip;</p>
            </div>-->
			...
			<div class="container">
				<div class="row">
					<div style="text-align: center;">
						<a href="SearchUser.jsp" class="btn btn-primary float-right">Back</a>
					</div>
				</div>
			</div>
